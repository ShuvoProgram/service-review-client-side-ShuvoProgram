    ...
    return (
        <div>
            ...
            <div className='mt-10'>
                ...
                <section className="mt-10 p-6 my-6 dark:bg-gray-800 dark:text-gray-100">
                    <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4 shadow-lg">
                ...
                <div className="w-full dark:bg-gray-500 mt-10" style={{ backgroundImage: `url('https://source.unsplash.com/random/640x480')`, backgroundPosition: "center center", backgroundBlendMode: "multiply", backgroundSize: "cover"}}>
                    <div className="container flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
                        ...
                        <p className="pt-2 pb-8 text-xl antialiased text-center text-gray-100">Find out about events</p>
                        <div className="flex flex-row">
                            <input type="text" placeholder="example@email.com" className="w-3/5 p-3 rounded-l-lg sm:w-2/3" style={{ backgroundImage: `url()`}}/>
                            <button type="button" className="w-2/5 p-3 bg-sky-500 font-semibold rounded-r-lg sm:w-1/3 dark:bg-violet-400 dark:text-gray-900">Subscribe</button>
                        </div>
                    </div>
                </div>
            </div>
